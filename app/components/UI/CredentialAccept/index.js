 ...
 */
class CredentialAccept extends PureComponent {
	static propTypes = {
		/**
				...
				<View style={styles.header}>
					...
					<View style={styles.signingInformation}>
						{showWarning ? (
							...
							<Text style={styles.signText}>You have received this credential</Text>
						)}
					</View>
				</View>
				<ActionView
...
export default connect(mapStateToProps)(CredentialAccept);
